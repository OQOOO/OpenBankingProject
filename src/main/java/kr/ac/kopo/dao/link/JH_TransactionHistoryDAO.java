...
public class JH_TransactionHistoryDAO implements HistoryDAO {
	@Override
	public List<HistoryVO> getAccountHistory(String acNum) {
		StringBuilder sql = new StringBuilder();
		sql.append("SELECT * ");
		sql.append("FROM TRANSACTION_HISTORY @JH ");
	...
	public void insertRecord(BankAccountVO vo, Connection conn) {
		StringBuilder sql = new StringBuilder();
		sql.append("INSERT INTO TRANSACTION_HISTORY @JH (TR_NUMBER, AC_NUMBER, TR_AC_NUMBER, TR_NAME, AMOUNT) ");
