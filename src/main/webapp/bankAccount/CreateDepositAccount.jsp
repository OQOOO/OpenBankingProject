...
<style>
	#container {
			...
			grid-template-rows: 100px 45px 100px 60px 60px 100px;
	}
	#container div {
...
<body>
	...
	<div id="main">
		<h1>적금계좌 개설</h1>
		<form action="${pageContext.request.contextPath }/bankAccount/createDepositAccount.do" method="post">
			<div id="container">
				<div class="textDiv">
					계좌 이름
				</div>
				...
				<div class="inputDiv">
					...
					<p class="errerMessage">${requestScope.accountPwErrer}</p> <br>
				</div>
				<script>
				...
				<div class="inputDiv">
					<input type="number" name="regularTransfer" value="${requestScope.regularTransfer}"><br>
					<p class="errerMessage">${requestScope.regularTransferErrer}</p> <br>
				</div>
				<div class="textDiv">
					입금계좌번호
				</div>
